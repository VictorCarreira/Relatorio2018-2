...
\begin{figure}[H]
	\centering
	\subfigure{\includegraphics[width=2.5cm, height=2.5cm]{Imagens/legenda.png}}
	\qquad                                                           
	\subfigure[ref1][Litologia]{\includegraphics[width=2.8cm, height=12cm]{Imagens/1BN0002SC_lit2.png}}
	\qquad                                                             
	\subfigure[ref2][SP]{\includegraphics[width=3.0cm]{Imagens/1BN0002SC_SP.png}}
	\qquad
	\subfigure[ref3][RLAT]{\includegraphics[width=3.0cm]{Imagens/1BN0002SC_res.png}}
	\qquad
...
\begin{figure}[H]
    ...
    \subfigure[ref1][Litologia]{\includegraphics[width=2.8cm, height=12cm]{Imagens/1BN0002SC_lit2.png}}
    \qquad                                                             
	\subfigure[ref4][TTI]{\includegraphics[width=3.0cm]{Imagens/1BN0002SC_TTI.png}}
	\qquad
	\subfigure[ref5][TOT]{\includegraphics[width=3.0cm]{Imagens/1BN0002SC_TOT.png}}
	\qquad
